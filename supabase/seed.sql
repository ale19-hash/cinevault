...
insert into titles
  (slug, name, type, release_year, runtime_minutes, seasons, critic_score, director, tagline, synopsis, language, country, hue, featured)
values
  ('the-matrix', 'The Matrix', 'movie', 1999, 136, null, 8.7, 'Lana & Lilly Wachowski', 'Free your mind.', 'A hacker discovers reality is a simulation and joins a rebellion against its machine architects.', 'English', 'USA', 0, true),
  ('inception', 'Inception', 'movie', 2010, 148, null, 8.8, 'Christopher Nolan', 'Your mind is the scene of the crime.', 'A thief who steals secrets through dream-sharing technology is offered a chance to have his criminal history erased.', 'English', 'USA', 137, false),
  ('parasite', 'Parasite', 'movie', 2019, 132, null, 8.5, 'Bong Joon-ho', 'Act like you own the place.', 'Greed and class discrimination threaten the newly formed symbiotic relationship between a wealthy family and a destitute one.', 'Korean', 'South Korea', 274, true),
  ('spirited-away', 'Spirited Away', 'movie', 2001, 125, null, 8.6, 'Hayao Miyazaki', 'The stuff of legend.', 'A young girl wanders into a world ruled by gods and spirits, and must find a way to free herself and return home.', 'Japanese', 'Japan', 51, true),
  ('the-godfather', 'The Godfather', 'movie', 1972, 175, null, 9.2, 'Francis Ford Coppola', 'An offer you can''t refuse.', 'The aging patriarch of an organized crime dynasty transfers control to his reluctant son.', 'English', 'USA', 188, false),
  ('pulp-fiction', 'Pulp Fiction', 'movie', 1994, 154, null, 8.9, 'Quentin Tarantino', 'You won''t know the facts until you''ve seen the fiction.', 'The lives of two hitmen, a boxer, a gangster and his wife intertwine in four tales of violence and redemption.', 'English', 'USA', 325, false),
  ('the-dark-knight', 'The Dark Knight', 'movie', 2008, 152, null, 9.0, 'Christopher Nolan', 'Welcome to a world without rules.', 'Batman raises the stakes in his war on crime as the Joker plunges Gotham into anarchy.', 'English', 'USA', 102, false),
  ('get-out', 'Get Out', 'movie', 2017, 104, null, 7.7, 'Jordan Peele', 'Just because you''re invited doesn''t mean you''re welcome.', 'A young man uncovers a disturbing secret when he meets his white girlfriend''s parents for the first time.', 'English', 'USA', 239, false),
  ('la-la-land', 'La La Land', 'movie', 2016, 128, null, 8.0, 'Damien Chazelle', 'Here''s to the fools who dream.', 'A jazz pianist and an aspiring actress fall in love while pursuing their dreams in Los Angeles.', 'English', 'USA', 16, false),
  ('mad-max-fury-road', 'Mad Max: Fury Road', 'movie', 2015, 120, null, 8.1, 'George Miller', 'What a lovely day.', 'In a post-apocalyptic wasteland, a woman rebels against a tyrannical ruler in search of her homeland.', 'English', 'Australia', 153, false),
  ('everything-everywhere-all-at-once', 'Everything Everywhere All at Once', 'movie', 2022, 140, null, 7.8, 'Daniel Kwan & Daniel Scheinert', 'The universe is so much bigger than you realize.', 'An exhausted laundromat owner is swept into an adventure connecting her to parallel universes.', 'English', 'USA', 290, true),
  ('the-grand-budapest-hotel', 'The Grand Budapest Hotel', 'movie', 2014, 99, null, 8.1, 'Wes Anderson', 'A no-holds-barred romp.', 'A legendary concierge and his protégé become embroiled in a murder investigation involving a priceless painting.', 'English', 'Germany', 67, false),
  ('whiplash', 'Whiplash', 'movie', 2014, 106, null, 8.5, 'Damien Chazelle', 'The road to greatness can take you to the edge.', 'A young drummer enrolls at a cutthroat music conservatory where a ruthless instructor pushes him to his limits.', 'English', 'USA', 204, false),
  ('interstellar', 'Interstellar', 'movie', 2014, 169, null, 8.7, 'Christopher Nolan', 'Mankind was born on Earth. It was never meant to die here.', 'A team of explorers travels through a wormhole in space in an attempt to save humanity.', 'English', 'USA', 341, false),
  ('knives-out', 'Knives Out', 'movie', 2019, 130, null, 7.9, 'Rian Johnson', 'Hell, everyone in this family has a motive.', 'A detective investigates the death of a wealthy crime novelist during a gathering of his eccentric family.', 'English', 'USA', 118, false),
  ('jaws', 'Jaws', 'movie', 1975, 124, null, 8.0, 'Steven Spielberg', 'Don''t go in the water.', 'A giant great white shark terrorizes a small beach town, forcing the sheriff to hunt it down.', 'English', 'USA', 255, false),
  ('alien', 'Alien', 'movie', 1979, 117, null, 8.5, 'Ridley Scott', 'In space no one can hear you scream.', 'The crew of a commercial spacecraft encounter a deadly lifeform after investigating a mysterious signal.', 'English', 'USA', 32, false),
  ('coco', 'Coco', 'movie', 2017, 105, null, 8.4, 'Lee Unkrich', 'The celebration of a lifetime.', 'A boy is transported to the Land of the Dead and uncovers the true story behind his family''s ancestral history.', 'English', 'USA', 169, false),
  ('the-shawshank-redemption', 'The Shawshank Redemption', 'movie', 1994, 142, null, 9.3, 'Frank Darabont', 'Fear can hold you prisoner. Hope can set you free.', 'Two imprisoned men bond over years, finding solace and eventual redemption through acts of common decency.', 'English', 'USA', 306, false),
  ('fight-club', 'Fight Club', 'movie', 1999, 139, null, 8.8, 'David Fincher', 'Mischief. Mayhem. Soap.', 'An insomniac office worker and a soap maker form an underground fight club that spirals into something much bigger.', 'English', 'USA', 83, false),
  ('amelie', 'Amélie', 'movie', 2001, 122, null, 8.3, 'Jean-Pierre Jeunet', 'One person can change your life forever.', 'A shy waitress secretly orchestrates small acts of kindness that transform the lives of those around her.', 'French', 'France', 220, false),
  ('city-of-god', 'City of God', 'movie', 2002, 130, null, 8.6, 'Fernando Meirelles', 'If you run, the beast catches you. If you stay, the beast eats you.', 'Two boys growing up in a violent Rio de Janeiro slum take vastly different paths in life.', 'Portuguese', 'Brazil', 357, false),
  ('your-name', 'Your Name', 'movie', 2016, 106, null, 8.4, 'Makoto Shinkai', 'They are searching for each other, even in their dreams.', 'Two teenagers discover they are mysteriously swapping bodies, forming a bond that crosses time and space.', 'Japanese', 'Japan', 134, false),
  ('breaking-bad', 'Breaking Bad', 'tv', 2008, null, 5, 9.5, 'Vince Gilligan', 'All hail the king.', 'A chemistry teacher turned methamphetamine manufacturer builds a criminal empire to secure his family''s future.', 'English', 'USA', 271, true),
  ('the-wire', 'The Wire', 'tv', 2002, null, 5, 9.3, 'David Simon', 'All the pieces matter.', 'Baltimore''s drug scene is examined through the eyes of law enforcement and the criminals they pursue.', 'English', 'USA', 48, false),
  ('stranger-things', 'Stranger Things', 'tv', 2016, null, 4, 8.7, 'The Duffer Brothers', 'Every ending has a beginning.', 'A group of kids uncover supernatural mysteries and government secrets in their small town.', 'English', 'USA', 185, false),
  ('the-office', 'The Office', 'tv', 2005, null, 9, 8.9, 'Greg Daniels', 'Welcome to Dunder Mifflin.', 'A mockumentary follows the everyday lives of office employees at a paper company in Scranton, Pennsylvania.', 'English', 'USA', 322, false),
  ('chernobyl', 'Chernobyl', 'tv', 2019, null, 1, 9.4, 'Craig Mazin', 'What is the cost of lies?', 'A dramatization of the true story of one of the worst nuclear disasters and the sacrifices made to save Europe.', 'English', 'UK', 99, false),
  ('fleabag', 'Fleabag', 'tv', 2016, null, 2, 8.7, 'Phoebe Waller-Bridge', 'A comedy about love, loss, and sex.', 'A dry-witted woman navigates grief, guilt, and relationships in modern London, breaking the fourth wall along the way.', 'English', 'UK', 236, false),
  ('avatar-the-last-airbender', 'Avatar: The Last Airbender', 'tv', 2005, null, 3, 9.3, 'Bryan Konietzko & Michael Dante DiMartino', 'Water. Earth. Fire. Air.', 'A young boy awakens after a century to fulfill his destiny as the Avatar who must bring balance to the world.', 'English', 'USA', 13, false),
  ('the-sopranos', 'The Sopranos', 'tv', 1999, null, 6, 9.2, 'David Chase', 'If one family doesn''t kill him, the other one will.', 'A New Jersey mob boss balances family life with the pressures of running a criminal organization, all while seeing a therapist.', 'English', 'USA', 150, false),
  ('succession', 'Succession', 'tv', 2018, null, 4, 8.8, 'Jesse Armstrong', 'The house always wins.', 'The Roy family fights for control of their global media empire as their aging patriarch''s health declines.', 'English', 'USA', 287, false),
  ('arcane', 'Arcane', 'tv', 2021, null, 2, 9.0, 'Christian Linke & Alex Yee', 'Two sisters. One city. A war that will change everything.', 'Two sisters on opposing sides of a brewing revolution fight to protect what they hold dear.', 'English', 'USA', 64, true),
  ('planet-earth-ii', 'Planet Earth II', 'tv', 2016, null, 1, 9.5, 'BBC Natural History Unit', 'The world as you have never seen it before.', 'A landmark nature documentary capturing wildlife across every continent in unprecedented detail.', 'English', 'UK', 201, false),
  ('portrait-of-a-lady-on-fire', 'Portrait of a Lady on Fire', 'movie', 2019, 122, null, 8.1, 'Céline Sciamma', 'Do all lovers feel like they are inventing something?', 'A painter falls for the reluctant bride-to-be she has been commissioned to paint in secret.', 'French', 'France', 338, false),
  ('spider-man-into-the-spider-verse', 'Spider-Man: Into the Spider-Verse', 'movie', 2018, 117, null, 8.4, 'Bob Persichetti, Peter Ramsey & Rodney Rothman', 'More than one wears the mask.', 'A teenager from Brooklyn becomes Spider-Man alongside five counterparts from across the multiverse.', 'English', 'USA', 115, false);
